...
//                UiUtil.copyToClipboard(context, selectedText)
                Toast.makeText(context, context.getString(R.string.content_copy_restrict), Toast.LENGTH_SHORT)
                    .show()
            }
            R.id.shareSelection -> {
                Log.v(LOG_TAG, "-> onTextSelectionItemClicked -> shareSelection -> $selectedText")
                Toast.makeText(context, context.getString(R.string.content_share_restrict), Toast.LENGTH_SHORT)
                    .show()
